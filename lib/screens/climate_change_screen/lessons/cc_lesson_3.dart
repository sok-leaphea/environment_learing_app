...
import '../Quiz/cc_quiz_1.dart';
import '../widgets/video_player_widget.dart';
import 'cc_lesson_2.dart';

class CcLesson3 extends StatefulWidget {
  const CcLesson3({super.key});

  @override
  State<CcLesson3> createState() => _CcLesson3State();
}

class _CcLesson3State extends State<CcLesson3> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text(
          'មេរៀនទី ៣៖ បម្រែបម្រួលអាកាសធាតុ',
          style: TextStyle(
          ...
          Container(
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const CcQuiz1()),
                );
              },
              style: ButtonStyle(
