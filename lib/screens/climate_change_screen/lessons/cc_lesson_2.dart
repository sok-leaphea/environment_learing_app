...
class CcLesson2 extends StatefulWidget {
  const CcLesson2({Key? key}) : super(key: key); // Added the correct syntax for the constructor

  @override
  State<CcLesson2> createState() => _CcLesson2State();
}

class _CcLesson2State extends State<CcLesson2> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text(
          'មេរៀនទី ២៖ បម្រែបម្រួលអាកាសធាតុ',
          style: TextStyle(
